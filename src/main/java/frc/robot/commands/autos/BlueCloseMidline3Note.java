...
public class BlueCloseMidline3Note 
{
        ...
        Collector collector, CollectorArm collectorArm, HandoffCommand handoffCommand)
    {
        ...
        Path.Point point5 = new Path.Point(7.4, -1.6);

        Pose2d shootPoint1 = new Pose2d(1.19, -0.97, new Rotation2d(0.44));
        //Pose2d collectPoint = new Pose2d(6.5, -1.2, new Rotation2d());
        Pose2d shootPoint2 = new Pose2d(5.0, -0.14, new Rotation2d(0.33));
        ...
        segments.add(new Segment(point5, point4, 0.33, 2.5));

        return new ParallelCommandGroup(
            SchemaDriveAuto.create(new DrivePathSchema(m_drivetrain, new Path(segments, 0.33)), m_drivetrain),
