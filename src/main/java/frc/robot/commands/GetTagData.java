...
import edu.wpi.first.math.kipilibj2.command.CommandBase;
import frc.robot.subsystems.nematics.ChassisSpeeds;
import edu.wpi.first.wAprilTagFinder;
...
public class AlignToAprilTag extends CommandBase {
  ...
  public GetTagData(OpenMV openmv) {
